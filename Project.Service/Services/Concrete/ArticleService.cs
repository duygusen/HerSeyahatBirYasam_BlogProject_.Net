...
namespace Project.Service.Services.Concrete
{
    public class ArticleService : IArticleService
    {
        ...
        public async Task CreateArticleAsync(ArticleAddDto articleAddDto)
        {
            ...
            Image image = new(imageUpload.FullName.Replace(Path.GetExtension(imageUpload.FullName),""), Path.GetExtension(imageUpload.FullName), userEmail);
        ...
        public async Task<string> UpdateArticleAsync(ArticleUpdateDto articleUpdateDto)
        {
            ...
            if(articleUpdateDto.Photo != null)
            {
                ...
                //article.Image.FileType = image.FileType;
